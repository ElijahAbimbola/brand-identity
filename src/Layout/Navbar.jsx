    ...
    <div>
       ...
       <div className=''>
        ...
        <div className='py-36 text-white px-5'>
            ...
            <h4 className='bg-darkgray border rounded-sm border-darkgray py-5 px-5'>Please note: Custom code is used for the price slider and the custom <br />slider arrows. Your site must be published to use the custom <br /> Details in page settings.</h4>
        </div>
    </div>
    </div>
